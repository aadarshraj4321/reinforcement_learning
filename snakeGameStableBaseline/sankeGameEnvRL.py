...
class SnakeEnv(gym.Env):
    ...
    def step(self, action):
        ...
        euclideanDistanceToApple = np.linalg.norm(np.array(self.snake_head) - np.array(self.apple_position))

        #self.totalReward = len(self.snake_position) - 3 - euclideanDistanceToApple
        self.totalReward = ((250 - euclideanDistanceToApple) + appleReward) / 100
        ...
        return self.observation, self.totalReward, self.done, self.truncated,  info
    ...
    def reset(self, seed=None, options=None):
        ...
        self.observation = [head_x, head_y, apple_delta_x, apple_delta_y, snake_length] + list(self.prev_actions)
        self.observation = np.array(self.observation, dtype="float32")
